...
export var cabintoiletries = [
  { item: "Small bottle of face cream and body lotion", checked: false },
  { item: "A small bottle of face wash", checked: false },
  { item: "Toothbrush and toothpaste", checked: false },
  { item: "Deodorants", checked: false },
  { item: "Hair brush", checked: false },
];
export var cabinelectronics = [
  { item: "Laptops + chargers", checked: false },
  { item: "Work headset", checked: false },
  { item: "GoPro + charger", checked: false },
  { item: "Drone + charger", checked: false },
  { item: "Microphone + charger", checked: false },
  { item: "iPhone mount/selfie stick", checked: false },
  { item: "Speaker", checked: false },
];
export var cabinmischellaneous = [
  { item: "Important documents(visas, prescriptions, travel insurance, identification, import permits, health certificate)", checked: false },
  { item: "Favourite pillow + neck pillow", checked: false },
  { item: "A book or Kindle", checked: false },
  { item: "Notebook + pen", checked: false },
];
export var cabinclothes = [
  { item: "Scarf/also as extra blanket", checked: false },
  { item: "Long trousers and sweater", checked: false },
  { item: "One change of clothes", checked: false },
  { item: "One change of underwear and socks", checked: false },
];
...
export var purseelectronics = [
  ...
  { item: "iPads", checked: false },
  { item: "Phones", checked: false },
  { item: "Headsets", checked: false },
  { item: "Powerbank", checked: false },
];
export var pursemischellaneous = [
  { item: "Passports", checked: false },
  { item: "Wallets + enough baht for taxi and import fees", checked: false },
  { item: "Snacks", checked: false },
  { item: "Snifferoos", checked: false },
  { item: "Mints and gum", checked: false },
  { item: "Favourite hand lotion**", checked: false },
  { item: "Favourite chapstick/lip balm**", checked: false },
  { item: "Eye blinds", checked: false },
  { item: "Foam earplugs", checked: false },
  { item: "Long warm socks", checked: false },
];
export var pursetoiletries = [
  { item: "Hand sanitizer", checked: false },
  { item: "Mini paper towels", checked: false },
  { item: "Wet wipes", checked: false },
  { item: "Tampons", checked: false },
  { item: "Nail file", checked: false },
  { item: "Chalk tablets", checked: false },
  { item: "Ibuprofen and paracetamol", checked: false },
  { item: "Sleeping pills", checked: false },
  { item: "Melatonin", checked: false },
  { item: "Allergy pills and nasal spray", checked: false },
  { item: "Sinus de-swelling spray", checked: false },
];
...
export var petmischellaneous = [
  ...
  { item: "Snacks", checked: false },
  { item: "His own blanket", checked: false },
  { item: "Food", checked: false },
  { item: "Travel toilet", checked: false },
  { item: "Travel harness and titer", checked: false },
  { item: "Microchip reader + charge", checked: false },
  { item: "Copy of owner passport", checked: false },
  { item: "1500 baht for import fees", checked: false },
];
